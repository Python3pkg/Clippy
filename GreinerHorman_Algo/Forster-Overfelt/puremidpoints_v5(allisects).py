...
class Polygon(object):
    ...
    # phase one - find intersections
        ...
        #   PROBLEM!!!! Doesnt detect all isects
        ...
        for s in self.iter(): # for each vertex Si of subject polygon do
            for c in clip.iter(): # for each vertex Cj of clip polygon do
                try:
                    ...
                    i, alphaS, alphaC = intersect_or_on(s, s.__next__, c, c.__next__)
...
if __name__ == "__main__":
    ...
    #***SPECIAL***clippoly = [(5,6),(5.2,5.5),(5,5.4),(4.8,5.5)] #degenerate, starts on edge intersection and goes outside
    ...
    #***SPECIAL***clippoly = [(0,0),(6,0),(6,6),(0,6),(0,0)] #degenerate, perfect overlap
    #***SPECIAL***clippoly = [(1,0),(6,0),(6,6),(1,6),(1,0)] #degenerate, partial inside overlap
    #***SPECIAL***clippoly = [(0,6),(6,6),(6,10),(0,10),(0,6)] #degenerate, right next to eachother
    #***SPECIAL***clippoly = [(2,6),(6,6),(6,10),(2,10),(2,6)] #degenerate, partial right next to eachother

    # REALLY DIFFICULT POLYS...
